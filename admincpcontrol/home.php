	...
	<div class="container">
		<div class="columns">
		  ...
		  <div class="column is-12">
		  	...
		  	?>
		  	<div class="nums_div">
		  		<div class="nums">عدد الاستمارات <?php echo $nums_qry->num_rows ?></div>
		  	</div>
							...
							<div class="admin_div">
								<div class="columns">
							  		<div class="column">
										...
										for ($i=1; $i < 7; $i++) { 
										$moh_qry = $conn->query("SELECT id FROM forms WHERE moh='$i'");
										?>
										<div class="filter">
											<div>
											...
											<div>
												<a href="report.php?moh=<?php echo $i ?>"><div><?php echo $moh[$i] ?> <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
											</div>
										</div>
										<?php
										}
				...
				<div class="columns">
					<div class="column is-3">
						  ...
						  <p class="panel-heading">
							...
							<div class="admin_div">
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE liv=1");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="liv" value="1">
									</div>
									<div>
										<a href="report.php?liv=1"><div value="<?php echo $i ?>">ملك <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE liv=2");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="liv" value="2">
									</div>
									<div>
										<a href="report.php?liv=2"><div value="<?php echo $i ?>">ايجار <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE liv=3");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="liv" value="3">
									</div>
									<div>
										<a href="report.php?liv=3"><div value="<?php echo $i ?>">عشوائيات <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
					...
					<div class="column is-3">
						  ...
						  <p class="panel-heading">
							...
							<div class="admin_div">
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE bdyear<=2001 AND bdyear>=1995");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="cage" value="2519">
									</div>
									<div>
										<a href="report.php?age=2519"><div>25-19 <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE bdyear<=1994 AND bdyear>=1985");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="cage" value="3526">
									</div>
									<div>
										<a href="report.php?age=3526"><div>35-26 <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE bdyear<=1984");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="cage" value="36">
									</div>
									<div>
										<a href="report.php?age=36"><div>36 فما فوق <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
					...
					<div class="column is-3">
						  ...
						  <p class="panel-heading">
							...
							<div class="admin_div">
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE job=1");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="report.php?job=1"><div>طالب <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE job=2");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="report.php?job=2"><div>موظفي حكومي <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE job=3");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="report.php?job=3"><div>كاسب <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE job=4");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="#"><div>اخرى <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
					...
					<div class="column is-3">
						  ...
						  <p class="panel-heading">
							...
							<div class="admin_div">
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE study=1");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="report.php?study=1"><div>دراسة جامعية <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE study=2");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="study" value="2">
									</div>
									<div>
										<a href="report.php?study=2"><div>معهد او اعدادية <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE study=3");
								?>
								<div class="filter">
									<div>
									...
									<div>
										<a href="report.php?study=3"><div>متوسطة <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
								
								<?php
								$moh_qry = $conn->query("SELECT id FROM forms WHERE study=4");
								?>
								<div class="filter">
									<div>
										<input type="checkbox" name="study" value="4">
									</div>
									<div>
										<a href="#"><div>ابتدائية <span class="tag is-light"><?php echo $moh_qry->num_rows ?></span></div></a>
									</div>
								</div>
...
<div class="field is-horizontal">
    ...
    <div class="field column">
		<label>اسم الجد الاول</label>
		<input type="text" name="g1Name1" />
		<div class="error" id="error19"></div>
    </div>
    <div class="field column">
		<label>اسم الجد الثاني</label>
		<input type="text" name="g2Name1" />
